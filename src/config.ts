...
export const siteConfig: SiteConfig = {
	title: "RookieSama",
	subtitle: "One blog",
	siteURL: "https://blog.rookiesama.space/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Rookie-MIN",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1679047226",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Rookie_MIN",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/yingying.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "RookieSama_",
	bio: "「誰かが必死に生きようとする、その意志や願いを奪うことは、神が全能であろうとも、罪なんだよ」",
	typewriter: {
	...
	links: [
		...
		// },
		{
			...
			url: "https://codeforces.com/profile/Rookie_MIN",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "欢迎来到小破站 \nようこそ私のブログへ！", // 公告内容
	closable: false, // 改为false，不允许用户关闭公告
	link: {
		enable: true, // 启用链接
		text: "Learn Morea", // 链接文本
		url: "/about/", // 链接 URL
		external: false, // 内部链接
	},
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://www.bilibili.uno/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址 bilibili: https://www.bilibili.uno/api?server=:server&type=:type&id=:id&auth=:auth&r=:r
